...
it('map(1) should throw a TypeError with message "The first parameter should be an array"', () => {
  let error
  ...
  expect(error.message).to.be.equal('The first parameter should be an array')
})
